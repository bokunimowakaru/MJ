100 cls:?"OLED BMP Downloader by W.Kunino"
110 B=0:goto220
200 'LINE
210 cls:uart0:forI=0to15:chr$(#E0+I);:next:?:?"Step ";B+1;"/8":gsb800
220 B=B+1:uart1:?"MJ GET bokunimowakaru.github.io/MJ/pg05/bmp/ras/";B;".txt"
230 end
800 'INIT
